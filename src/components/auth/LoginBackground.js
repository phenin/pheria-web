...
import 'css/login-background.scss'
...
export default function LoginBackground() {
  return (
    ...
    <div className="title-wrapper layer" data-depth="0.40">
      <h1 className="sign-in_wrap" data-title="The moonlight speaks to my heart" />
      <Login/>
    </div>
  </div>
  )
